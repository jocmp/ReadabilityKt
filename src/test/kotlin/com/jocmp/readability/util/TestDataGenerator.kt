...
class TestDataGenerator : TestDataGeneratorBase() {
    ...
    fun generateTestData(testFolderName: String, testCaseName: String, url: String) {
        ...
        val readability = Readability(url, webSiteHtml, ReadabilityOptions(additionalClassesToPreserve = listOf("caption")))
        val article = readability.parse()

        val readabilityExtended = ReadabilityExtended(url, webSiteHtml, ReadabilityOptions(additionalClassesToPreserve = listOf("caption")))
