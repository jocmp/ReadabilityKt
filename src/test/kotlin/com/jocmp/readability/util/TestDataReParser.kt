...
import com.jocmp.readability.extended.ReadabilityExtended
...
class TestDataReParser : TestDataGeneratorBase() {
    ...
    private fun reParseMozillasTestData(testCaseName: String) {
        reParseTestData(ReadabilityTest.READABILITY_FAKE_TEST_URL, "test-pages", testCaseName)
    }
    ...
    private fun reParseAdditionalTestData() {
        ...
        reParseAdditionalTestData(
            "http://www.faz.net/aktuell/politik/spd-sonderparteitag-begeisternde-rede-von-andrea-nahles-15410318-p2.html",
            "faz-2",
        )
        ...
        reParseAdditionalTestData(
            "http://www.sueddeutsche.de/wirtschaft/dienstleistungsgesellschaft-geiz-macht-arm-1.3764236",
            "sueddeutsche-1",
        )
        reParseAdditionalTestData(
    ...
    private fun getFileContentFromResource(
