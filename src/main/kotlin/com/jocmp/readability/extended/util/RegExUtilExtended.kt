package com.jocmp.readability.extended.util
...
open class RegExUtilExtended : RegExUtil {
    ...
    constructor(
        ...
        negativePattern: String = NEGATIVE_DEFAULT_PATTERN + NEGATIVE_DEFAULT_PATTERN_EXTENDED,
        ...
        removeImagePattern: String = REMOVE_IMAGE_DEFAULT_PATTERN,
    ) :
        super(
            unlikelyCandidatesPattern,
            okMaybeItsACandidatePattern,
            positivePattern,
            negativePattern,
            extraneousPattern,
            bylinePattern,
